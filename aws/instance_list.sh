aws ec2 describe-instances --query 'Reservations[].Instances[].[Tags[?Key==`Name`] |[0].Value,PublicIpAddress,PrivateIpAddress,InstanceId,State.Name]' --output=table > /home/slack_op/aws.txt
